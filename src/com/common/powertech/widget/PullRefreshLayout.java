...
/**
 * PullRefreshLayout is designed to activate an action by pull. It base on
 * FrameLayout. This class defined two special child: actionView & toolView The
 * actionView can be use on pull action (Ex. pull to refresh). The toolView is a
 * hidden view on first showing, it can be use as a hidden tool bar. The two
 * special child will be identify by its id.
 * 
 */
