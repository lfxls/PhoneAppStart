 ...
 */
public class PULLParse_Reprint_Query {

    private static String rspcod, rspmsg, tolcnt;

    public static List<BillReprint_Class> getRPList(InputStream is) throws Exception{

        BillReprint_Class br = null;
        List<BillReprint_Class> brs = null;
        ...
        while (event != XmlPullParser.END_DOCUMENT){
            ...
            switch (event){
                case XmlPullParser.START_DOCUMENT:
                    brs = new ArrayList<BillReprint_Class>();
                    break;
                ...
                case XmlPullParser.START_TAG:
                    ...
                    if( br != null ){
                        ...
                        if( "METER_NO".equals( pullParser.getName() ) ){
                            br.Set_METER_NO(pullParser.nextText());
                        }
                        ...
                        if( "TOKEN".equals( pullParser.getName() ) ){
                            br.Set_TOKEN(pullParser.nextText());
                        }

                        if( "JSON".equals( pullParser.getName() ) ){
                            br.Set_JSON(pullParser.nextText());
                        }

                        if( "IC_JSON_RES".equals( pullParser.getName() ) ){
                            br.Set_IC_JSON_RES(pullParser.nextText());
                        }
                    }
                    break;
