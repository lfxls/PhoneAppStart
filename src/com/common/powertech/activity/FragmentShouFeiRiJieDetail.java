...
import com.common.powertech.activity.ShouFeiXiangQingActivity.PrinterServiceConnection;
 ...
 */
public class FragmentShouFeiRiJieDetail extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_shoufeirijie_main, container, false);
        btn1 = (Button) rootView.findViewById(R.id.btn_main_shoufeirijie_zaituchaxun);
            ...
            public void scrollBottomState() {
                ...
                if (!mInLoading) {
                    ...
                    if (ifZaitu) {
                        ...
                        Request_Daily_Query.setStatue("1");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (ifZaitu) {
                    ...
                    PrintNotice("<TICKET>" + ticket + "</TICKET>");
                }
            }
        });
...
//                Request_Daily_Query.setNumperpage("5");
        ...
        btn2 = (Button) rootView.findViewById(R.id.btn_main_shoufeirijie_daozhangchaxun);
...
//        Request_Daily_Query.setNumperpage("5");
    ...
    private ArrayList<HashMap<String, Object>> BD_getDate() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (ifZaitu) {
                map.put("btn", getString(R.string.str_quxiao));
            } else {
                map.put("btn", getString(R.string.str_dayin));
            }
            listItem.add(map);
        }
//        //多加一行 用于显示 上一页 下一页按钮
...
//        listItem.add(map);
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (position == list.size()) {
                ...
                tv6.setText(arrayList.get(position).get("tv6").toString());
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ifZaitu) {
                            //取消记录
                            CancelNotice(list.get(position).Get_TOF_NO());
                            index = position;
                        } else {
                            String temp = arlist.get(position);
                            String ticket = Client.Parse_XML(temp, "<TICKET>", "</TICKET>");
                            PrintNotice("<TICKET>" + ticket + "</TICKET>");
    ...
    private void PrintNotice(final String ticket) {

        new CustomDialog.Builder(mActivity).setTitle(getString(R.string.str_dayintishi))
                .setMessage(getString(R.string.str_dayinrijiedan))
    ...
    private void CancelNotice(final String tofno) {

        new CustomDialog.Builder(mActivity).setTitle(getString(R.string.str_quxiaorijie))
                .setMessage(getString(R.string.str_quxiaojilu))
                .setPositiveButton(getString(R.string.str_queding), new DialogInterface.OnClickListener() {//添加确定按钮
...
//                        btnprev.setEnabled(false);
                        ...
                        Request_Daily_Confirm.setStatue("1");

                        String APIName = "PBillDailyConfirm";
                        String data = Request_Daily_Confirm.getRequsetXML();
//                        ifNextPage = -1;
                        progress_show(getString(R.string.str_quxiaorijie));
                        Client.SendData(APIName, data, handler);
                        dialog.dismiss();
                    }
                }).setNegativeButton(getString(R.string.str_quxiao), new DialogInterface.OnClickListener() {//添加返回按钮
...
//    void Cancel_DailyRecord(String tofno){
//
//        btnprev.setEnabled(false);
//        Request_Daily_Confirm.setContext(mActivity);
//        Request_Daily_Confirm.setTofno(tofno);
