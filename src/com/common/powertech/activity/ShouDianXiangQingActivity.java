...
import com.gprinter.sample.CustomerDiaplayActivity;
...
public class ShouDianXiangQingActivity extends Activity {
    ...
    private TextView mUserNameAndNum, mUserAddr, mUserTel, mElecCompany,
            mMeterNo;
    private EditText mZidingshoudianjineEt, mPasswordET,phonenum;
    private ImageView mCloseImageView;
    private static Button m500Btn, m1000Btn, m1500Btn, m2000Btn, m2500Btn,
            mConfirmChargeBtn, bt_querengoudian, mBangkaBtn, mPrintAgainBtn,mSendSMSBtn;
...
//    private String mResultAmt = "";
    ...
    private AlertDialog mQuerengoudianDialog, mGoudianchenggongDialog,
            mBangkaDialog;
...
//                        + stateStrings[currState];
           /*     final String outputString =getString(R.string.writecard_check_card);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        logMsg1("请勿拔出ic卡");
                        SystemUtil.displayToast(getApplicationContext(), outputString);
...
//        registerReceiver(mCardMessageReceiver, filter);
    ...
    private void initUI() {
        ...
        mElecCompany.setText(mShouDianXiangQingItem.getELEN_ID());
...
//    				finish();
    ...
    public void showQuerengoudianDialog(Context mContext) {
        ...
        mZhifuzongeTV.setText(keepDecimalPlaces(String.valueOf(mAmt)));//
...
//                            .compile("^(-)?(([1-9]{1}\\d*)|([0]{1}))((\\.(\\d){1,2})?$");
    ...
    private boolean feeQuery() {// 购电服务费查询 成功返回true，失败返回false
        ...
        Request_ShouDianFee_Query.setMeterNo(mShouDianXiangQingItem
                .getMETER_NO());
...
//        }
        ...
        Request_Shoudianshoufei_Query.setAmt(keepDecimalPlaces(mAmt));// 总金额
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    if (!rspCode.equals("00000")) {// 请求失败
                        ...
                        SystemUtil.displayToast(ShouDianXiangQingActivity.this,
                                getString(R.string.dlg_goudianchenggong_title));
                        try {
                            // 获取押金余额并更新主界面
