...
import com.common.powertech.activity.FragmentShoufeiDetail;
...
public class ItemDetailFragmentController extends Fragment implements ReadCardMessageCallBack {
	...
	String mUserNo;
	String mIcFlag;
	private Button buttonByUser, buttonByElecWatch, buttonChongzhengQuery;
...
//				});
			...
			rootView = inflater.inflate(R.layout.fragment_shouzhimingxi_main, container, false);
...
private String getHex(int a,boolean b){
	...
	OnClickListener numberOnclickListener = new OnClickListener() {
		@Override
		public void onClick(View v) {
			String temp = StringUtil.convertStringNull(inputCond.getText().toString());
			String tempPre = temp.substring(0, inputCond.getSelectionEnd());
			String tempLes = temp.substring(inputCond.getSelectionEnd(), temp.length());
			switch (v.getId()) {
			case R.id.button1:
